...
declare type ActionType = "condition" | "resource" | "interval" | "schedule" | "mqtt_topic";
declare type ActionTypeParams = {
    script: GenericID[];
    type: "script";
} | {
    message: string;
...
declare type ActionQuery = Query<ActionInfo, "name" | "active" | "locked" | "last_triggered" | "created_at" | "updated_at">;
